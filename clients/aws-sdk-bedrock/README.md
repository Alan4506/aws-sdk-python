...
The `aws-sdk-bedrock` package provides a client for making
...
```bash
python -m pip install aws-sdk-bedrock
```

## Documentation

- [API Reference](https://docs.aws.amazon.com/sdk-for-python/v1/reference/clients/bedrock/) -
  the Bedrock client, available operations, and types.
