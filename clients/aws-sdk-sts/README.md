...
The `aws-sdk-sts` package provides a client for making
...
- [API Reference](https://docs.aws.amazon.com/sdk-for-python/v1/reference/clients/sts/) -
  the STS client, available operations, and types.
