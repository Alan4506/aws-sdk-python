# Amazon Simple Notification Service Client

The `aws-sdk-sns` package provides a client for making
...
- [API Reference](https://docs.aws.amazon.com/sdk-for-python/v1/reference/clients/sns/) -
  the SNS client, available operations, and types.
