...
The `aws-sdk-cloudtrail` package provides a client for making
...
```bash
python -m pip install aws-sdk-cloudtrail
```

## Documentation

- [API Reference](https://docs.aws.amazon.com/sdk-for-python/v1/reference/clients/cloudtrail/) -
  the CloudTrail client, available operations, and types.
