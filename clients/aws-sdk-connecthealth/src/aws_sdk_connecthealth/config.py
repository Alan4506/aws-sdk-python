...
from ._private.schemas import CONNECT_HEALTH as _SCHEMA_CONNECT_HEALTH
...
_ServiceInterceptor = Union[
    Interceptor[ActivateSubscriptionInput, ActivateSubscriptionOutput, Any, Any],
    ...
    Interceptor[DeactivateSubscriptionInput, DeactivateSubscriptionOutput, Any, Any],
    Interceptor[DeleteDomainInput, DeleteDomainOutput, Any, Any],
    Interceptor[GetDomainInput, GetDomainOutput, Any, Any],
    Interceptor[
        GetMedicalScribeListeningSessionInput,
        GetMedicalScribeListeningSessionOutput,
        Any,
    ...
    Interceptor[GetPatientInsightsJobInput, GetPatientInsightsJobOutput, Any, Any],
    Interceptor[GetSubscriptionInput, GetSubscriptionOutput, Any, Any],
    ...
    Interceptor[StartPatientInsightsJobInput, StartPatientInsightsJobOutput, Any, Any],
...
class Config:
    """Configuration for ConnectHealth."""
    ...
    def __init__(
        ...
        *,
        ...
        self.auth_schemes = auth_schemes or {
            ShapeID("aws.auth#sigv4"): SigV4AuthScheme(service="health-agent")
        }
        ...
        self.protocol = protocol or RestJsonClientProtocol(_SCHEMA_CONNECT_HEALTH)
        self.region = region
