...
_ServiceInterceptor = Union[
    ...
    Interceptor[PutSessionInput, PutSessionOutput, Any, Any],
    Interceptor[RecognizeTextInput, RecognizeTextOutput, Any, Any],
    Interceptor[RecognizeUtteranceInput, RecognizeUtteranceOutput, Any, Any],
    Interceptor[StartConversationInput, StartConversationOutput, Any, Any],
]


@dataclass(init=False)
class Config:
    """Configuration for Lex Runtime V2."""
    ...
    def __init__(
        ...
        *,
        ...
        self.auth_schemes = auth_schemes or {
            ShapeID("aws.auth#sigv4"): SigV4AuthScheme(service="lex")
        }
        ...
        self.protocol = protocol or RestJsonClientProtocol(
            _SCHEMA_AWS_DEEP_SENSE_RUN_TIME_SERVICE_API2_0
        )
        self.region = region
