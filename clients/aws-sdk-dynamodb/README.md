...
The `aws-sdk-dynamodb` package provides a client for making
...
- [API Reference](https://docs.aws.amazon.com/sdk-for-python/v1/reference/clients/dynamodb/) -
  the DynamoDB client, available operations, and types.
