...
The `aws-sdk-polly` package provides a client for making
...
```bash
python -m pip install aws-sdk-polly
```

## Documentation

- [API Reference](https://docs.aws.amazon.com/sdk-for-python/v1/reference/clients/polly/) -
  the Polly client, available operations, and types.
